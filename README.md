...
<p align="center">
  ...
  <a href="https://github.com/Mikasmarthome/ThermoSmart/releases"><img src="https://img.shields.io/badge/version-v1.0.7-blue.svg" alt="Version"/></a>
...
HACS → Integrations → find **ThermoSmart** → **Download** → select `v1.0.7` → Download
